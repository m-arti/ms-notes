...
The preceding three statements nudge me to mull over the role and symbolism of the camera, during particular [events](https://en.wikipedia.org/wiki/Police_brutality) that occurred in 2020. Berger said that the camera *"which isolates a moment of agony isolates no more violently than the experience of that moment isolates itself"* (p. 32). That is, an experience is always sharper than the effect its photograph can evoke. Under what conditions and to what extent does the presence of the camera—its unflinching gaze and propensity for immediate broadcast—deter or subdue acts of violence?
