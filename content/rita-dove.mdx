...
<img class="absolute inset-0 z-0" src="https://picsum.photos/536/354" alt="Workplace" width="600" />


<NoteTag color="gray">people</NoteTag>
<NoteTag color="gray">poetry</NoteTag>

<div class="flex-0 flex-shrink overflow-x-hidden items-center absolute inset-0 z-0 bg-cover bg-center h-32 w-full max-w-2xl md:overflow-x-auto overflow-y-hidden " style="background-image: url('https://www.wolframcloud.com/obj/mar/header-rita-dove'); min-height:250px; display:block;" alt="American poet Rita Dove"></div>
