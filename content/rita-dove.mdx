...
<div class="background-image absolute inset-0 block bg-cover bg-center h-32 w-full min-w-full" style="background-image: url('https://www.wolframcloud.com/obj/mar/header-rita-dove'); min-height:250px; display:block; vertical-align:middle;" alt="American poet Rita Dove"></div>
