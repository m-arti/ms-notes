...
<div class="flex-0 flex flex-grow overflow-x-hidden md:overflow-x-auto overflow-y-hidden absolute inset-0 z-0 bg-cover bg-center h-32 w-full max-w-2xl" style="background-image: url('https://www.wolframcloud.com/obj/mar/header-rita-dove'); min-height:250px; right:0px; display:block;" alt="British polymath Stephen Wolfram"></div>
